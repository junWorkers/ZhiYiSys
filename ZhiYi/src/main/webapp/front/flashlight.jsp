...
<body>
	<div id="fa-moblie">
		...
		<div id="PageMain" class="main">
			<div id="pageImg">
				<img style="display:block" src="images/recommend_8.png" />
			</div>
			<div class="content">
					...
					<div class="container-app">
						<div class="app-title">
							<ul>
								...
								<li><a href="fa.jsp">应用&gt;</a>
								</li>
								<li><a href="#">nubia手电筒</a>
								</li>
							</ul>
						</div>
						<div class="app-detail">
							<div class="app-content">
								<div class="left ">
									<img src="images/content_6.png" alt="" height="76" width="76">
									<a href="#">
										<h2>nubia手电筒</h2> </a>
									<div class="star"></div>
								...
								<div class="right">
									<ul>
										<li><span>应用名称：</span>nubia手电筒</li>
										<!-- 分类和价格先不实现。
									<li><span>分类：</span>1</li>
									<li><span>价格：</span> <b>免费</b> </li>
									-->
										<li><span>更新时间：</span>2015-09-02 17:15:02</li>
										<li><span>软件大小：</span>985.13KB</li>
										<li><span>开发商：</span>努比亚</li>
										<li><span>应用简介：</span>
											<p>nubia手电筒V1.1</p>
											<p>版本说明：</p>
											<p>
												1：最小可用的安卓版本调整为4.0<br> 2：优化了apk大小
											</p></li>
									</ul>
								</div>
							</div>
