...
.user-serices li a {
	...
	font-weight: bold;
	background: #eeeeee url(/res/images/bgs.png) repeat-x 0 -40px;
	border-radius: 4px;
}

.user-serices li a:hover {
	color: #fff;
	background: #e8380d url(/res/images/bgs.png) repeat-x 0 -330px;
}
</style>
