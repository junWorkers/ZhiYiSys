								...
								<div class="horizontal">
									<div class="clip clip-horizontal">
										<ul
											...
											<li jcarouselindex="2">style="float: left; list-style:
												outside none none;" class="jcarousel-item-horizontal> <img
												src="images/c-2.jpg" alt="">
											</li>
											<li jcarouselindex="3"
												style="float: left; list-style: outside none none;"
												class="jcarousel-item-horizontal"><img
												src="images/c-3.jpg" alt=""></li>
											<li jcarouselindex="4"
												style="float: left; list-style: outside none none;"
												class="jcarousel-item-horizontal"><img
												src="images/c-4.jpg" alt=""></li>
										</ul>
									</div>
								</div>
							</div>
