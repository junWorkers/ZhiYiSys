...
<body>
	<div id="fa-moblie">
		...
		<div id="PageMain" class="main">
			<div id="pageImg">
				<img style="display:block" src="images/recommend_11.png" />
			</div>
			<div class="content">
					...
					<div class="container-app">
						...
						<div class="app-detail">
							<div class="app-content">
								...
								<div class="right">
									<ul>
										<li><span>应用名称：</span>nubia电工</li>
										<!-- 分类和价格先不实现。
									<li><span>分类：</span>1</li>
									<li><span>价格：</span> <b>免费</b> </li>
									-->
										<li><span>更新时间：</span>2015-09-02 17:07:55</li>
										<li><span>软件大小：</span>3.54M</li>
										<li><span>开发商：</span>努比亚</li>
										<li><span>应用简介：</span>
											<P>
												一款好用的省电软件：<BR>1.耗电优化，让设备保持在最佳状态；<BR> 2.查看应用耗电排行<BR>3.管理应用联网<BR>4.独有的省电技术，更理想的省电效果；<BR>
												5.支持 Android 4.4以上版本<BR>
											</P></li>
									</ul>
								</div>
							</div>
