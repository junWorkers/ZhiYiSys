    ...
    <div class="nb-stage high start return">
				...
				<div class="section">
					...
					<c:forEach items="${goodsaaaa}" var="item">
						...
						<a class="readmore-btn" onClick="check1()" href="javascript:void(0)">立即购买</a>
					</div>
				</div>
			...
			<c:forEach items="${goodsaaaa}" var="item">
				...
				<div class="section">
					...
					<div class="figure">
						<img style="visibility: visible;" src="${item.firstPath }" height="590" width="285">
					</div>
				</div>
					</c:if>
        				</c:if>
			...
			<div class="nb-stage s4" onMouseOver="gundong()">
				...
				<c:forEach items="${goodsaaaa}" var="item">
						...
						<ul>
							<li class="n1"><img src="images/zx300-s4-sc1.png" height="120" width="100">
                            	<span><strong id="add1">0.1</strong><b>次</b></span><p>nubia Z9 系列手机充电</p>
                            </li>
							<li class="n2"><img src="images/zx300-s4-sc2.png" height="120" width="100">
                            	<span><strong id="add2">0.1</strong><b>次</b></span><p>iPhone 6 手机充电</p>
                            </li>
							<li class="n3"><img src="images/zx300-s4-sc3.png" height="120" width="100">
                            	<span><strong id="add3">0.1</strong><b>次</b></span><p>iPhone 6 Plus 手机充电</p>
                            </li>
						</ul>
					</div>
				</div>
            ...
            <div class="nb-purchase-popup" id="fa-click">
				<a class="nb-p-close" href="#"><img onClick="check2()" src="images/nb-p-close-ico.jpg" height="40" width="40"></a>
				<div class="nb-p-layer">
					<div class="figure-area">
						<img style="z-index:9;display:block; opacity: 1;" src="images/nb-p-figure1.jpg" height="410" width="410">
						<img style="z-index:1;display:none;" src="images/nb-p-figure2.jpg" height="410" width="410">
						<img style="z-index: 1; display: none;" src="images/nb-p-figure3.jpg" height="410" width="410">
						<img style="z-index: 1; display: none;" src="images/nb-p-figure4.jpg" height="410" width="410">
					</div>
					<div class="nbp-goods-info">
						...
						<dl class="nbp-goods-color">
							<dt>选择颜色</dt>
							<dd>
								<a data-value="白色" class="border current" style="background-color:#FFFFFF;" 
                                	buylimitnumber="0" sid="590" href="#"><em></em></a>
								<a data-value="橙色" class="border" style="background-color:#FFA500;" 
                                	buylimitnumber="0" sid="696" href="#"><em></em></a>
