		...
		<div class="nb-mobile-contain">
			<div class="cl nb-ml-h-nav-box">
				...
				<div class="nb-ml-side">
					<ul id="uls">
						<li class="nb-z-ico" data-top="0" onMouseOver="show(1)"
							onMouseOut="show(7)"><a class="cl" href="javascript:void(0)">
								<em class="nb-ico"></em> <b class="nb-ico"></b>
							...
							<div style="display: none; top: -1px;" class="nb-mlside-menu cl"
								id="1">
						...
						<li class="nb-x-ico" data-top="0" onMouseOver="show(2)"
							onMouseOut="show(7)"><a class="cl" href="javascript:void(0)">
								<em class="nb-ico"></em> <b class="nb-ico"></b>
						...
						<li class="nb-x-ico" data-top="0" onMouseOver="show(3)"
							onMouseOut="show(7)"><a class="cl" href="javascript:void(0)">
								<em class="nb-ico"></em> <b class="nb-ico"></b>
						...
						<li class="nb-access-ico" data-top="-100" onMouseOver="show(4)"
							onMouseOut="show(7)"><a class="cl" href="javascript:void(0)">
								<em class="nb-ico"></em> <b class="nb-ico"></b>
						...
						<li class="nb-other-ico" data-top="-35" onMouseOver="show(5)"
							onMouseOut="show(7)"><a class="cl" href="javascript:void(0)">
								<em class="nb-ico"></em> <b class="nb-ico"></b>
				...
				<div class="nb-ml-high">
					<div style="max-width: 100%;" class="bx-wrapper">
						<div
							style="width: 73%; overflow: hidden; position: relative; height: 360px; padding-left: 0px;"
							class="bx-viewport">
							...
							<div class="bx-pager bx-default-pager">
								<div class="bx-pager-item" id="bx-pager-item">
									<a href="" data-slide-index="0" class="bx-pager-link active"
										id="a1">1</a> <a href="" data-slide-index="1"
										class="bx-pager-link " id="a2">2</a> <a href=""
										data-slide-index="2" class="bx-pager-link" id="a3">3</a> <a
										href="" data-slide-index="3" class="bx-pager-link" id="a4">4</a>
								</div>
							</div>
				...
				<div class="nb-ml-nr-item i-left">
					<c:forEach items="${Allgoods}" var="item">
						<c:if test="${item.gposition eq 6}">
							<div class="figure">
								<img src="${item.firstPic}" height="250" width="250">
							</div>
				...
				<dl class="cl nb-mall-m-hot">
					...
					<dd class="nbc-new-box">
						<ul class="cl">
								...
								<dl>
									<dd style="display: block;" id="c1">
										...
										<div class="nbc-pro-info">
											...
											<p class="price">
												￥<span>${Gcontent[0].price}</span>
											</p>
											<div class="link">
												<a href="#">立即购买</a> <a href="#">查看详情</a>
											</div>
										</div>
							...
							<li class="nbc-new-pro2 cl goods-hover-shows"><a href="#">
									<c:forEach items="${Allgoods}" var="item">
										<c:if test="${item.gposition eq 9}">
											<div class="nbc-pro-cont">
												<div class="figure">
													<img src="${item.firstPic}" width="393" height="380">
												</div>
												<div class="price">
													<h2>${item.gname}</h2>
					...
					<dd class="nbc-new1-box">
						<ul class="cl">
							<li class="clear-margin-left goods-hover-shows"><a href="#">
									<div class="nbc-pro-cont">
										<div class="figure">
											<img src="${Gcontent1[0].gpath}" width="393" height="380">
										</div>
										<div class="price">
							...
							<li class="goods-hover-shows"><a href="#">
									<div class="nbc-pro-cont">
										<div class="figure">
											<img src="${Gcontent1[1].gpath}" width="393" height="380">
										</div>
										<div class="price">
							...
							<li class="goods-hover-shows"><a href="#">
									<div class="nbc-pro-cont">
										<div class="figure">
											<img src="${Gcontent1[2].gpath}" width="393" height="380">
										</div>
										<div class="price">
							...
							<li class="clear-margin-left goods-hover-shows"><a href="#">
									<div class="nbc-pro-cont">
										<div class="figure">
											<img src="${Gcontent1[3].gpath}" width="393" height="380">
										</div>
										<div class="price">
							...
							<li class="goods-hover-shows"><a href="#">
									<div class="nbc-pro-cont">
										<div class="figure">
											<img src="${Gcontent1[4].gpath}" width="393" height="380">
										</div>
										<div class="price">
							...
							<li class="goods-hover-shows"><a href="#">
									<div class="nbc-pro-cont">
										<div class="figure">
											<img src="${Gcontent1[5].gpath}" width="393" height="380">
										</div>
										<div class="price">
							...
							<c:forEach items="${Allgoods}" var="item">
								<c:if test="${item.gposition eq 11}">
									<li class="cl left-side" style="margin-bottom: 10px">
										<div class="figure">
											<a href="#"> <img src="${item.gpath }" width="270"
												height="270">
											</a>
										</div>
			...
			<li class="right-side" style="margin-bottom: 10px"><c:forEach
					items="${Allgoods}" var="item">
			...
			<dl class="cl nb-mall-m-access">
				...
				<dt class="sub-nav-bar">
					<ul class="cl">
						<li><a href="#"> <img src="${Gcontent2[0].gpath }"
								width="150" height="80">
								<p>${Gcontent2[0].gname }</p>
						</a></li>
						<li><a href="#"> <img src="${Gcontent2[1].gpath }"
								width="150" height="80">
								<p>${Gcontent2[1].gname }</p>
						</a></li>
						<li><a href="#"> <img src="${Gcontent2[2].gpath }"
								width="150" height="80">
								<p>${Gcontent2[2].gname }</p>
						</a></li>
						<li><a href="#"> <img src="${Gcontent2[3].gpath }"
								width="150" height="80">
								<p>${Gcontent2[3].gname }</p>
						</a></li>
						<li><a href="#"> <img src="${Gcontent2[4].gpath }"
								width="150" height="80">
				...
				<dd>
					<ul>
						<li class="ac1 goods-hover-shows"><a href="#">
								<div class="nbc-pro-cont">
									<div class="figure">
							...
							<div class="nbc-pro-info">
								...
								<div class="link">
									<a href="#">加入购物车</a> <a href="#">查看详情</a>
								</div>
							</div></li>

						<li class="ac2 goods-hover-shows"><a href="#">
								<div class="nbc-pro-cont">
									<div class="figure">
						...
						<li class="ac3 goods-hover-shows"><a href="#">
								<div class="nbc-pro-cont">
									<div class="figure">
						...
						<li class="ac4 goods-hover-shows"><a href="#">
								<div class="nbc-pro-cont">
									<div class="figure">
						...
						<li class="ac-big goods-hover-shows"><a href="#">
								<div class="nbc-pro-cont">
									<div class="figure">
										<img src="${Gcontent3[4].gpath }" width="393" height="600">
									</div>
									<div class="price">
			...
			<dl class="cl nb-mall-m-rel">
				...
				<dd>
					<ul class="cl">
						...
						<li class=" goods-hover-shows" style="margin-bottom: 10px"><a
							href="#">
								<div class="nbc-pro-cont">
									<div class="figure">
										<img src="${Gcontent4[1].gpath }" width="270" height="270">
									</div>
									<div class="price">
						...
						<li class=" goods-hover-shows" style="margin-bottom: 10px"><a
							href="#">
								<div class="nbc-pro-cont">
									<div class="figure">
										<img src="${Gcontent4[2].gpath }" width="270" height="270">
									</div>
									<div class="price">
				...
				<dd class="nbc-shop-box">
					<div class="nbc-shop-contact">
						...
						<div class="goodexchange">
							<div class="figure">
								<img src="images/nbc-shop-goodexchange-ico.jpg" width="84"
									height="84">
							</div>
							<p>15天免费上门换货</p>
						</div>
		...
		<div class="nb-mbc-foot">
			...
			<div class="foot-link cl">
				<dl class="cl ffff">
					<dt>关于我们</dt>
					<dd>
						<a target="_blank" href="#">关于nubia</a>
					</dd>
					<dd>
						<a target="_blank" href="#">新闻中心</a>
					</dd>
					<dd>
						<a target="_blank" href="#">体验店</a>
					</dd>
					<dd>
				...
				<dl class="cl">
					<dt>手机</dt>
					<dd>
						<a target="_blank" href="#">nubia Z9</a>
					</dd>
					<dd>
						<a target="_blank" href="#">nubia Z9 Max</a>
					</dd>
					<dd>
						<a target="_blank" href="#">nubia Z9 mini</a>
					</dd>
					<dd>
						<a target="_blank" href="#">nubia Z7</a>
					</dd>
					<dd>
						<a target="_blank" href="#">nubia Z7 Max</a>
					</dd>
					<dd>
						<a target="_blank" href="#">nubia Z7 mini</a>
					</dd>
					<dd>
						<a target="_blank" href="#">nubia X6</a>
					</dd>
				</dl>
				<dl class="cl">
					<dt>配件</dt>
					<dd>
						<a target="_blank" href="#">保护壳</a>
					</dd>
					<dd>
						<a target="_blank" href="#">皮套</a>
					</dd>
					<dd>
						<a target="_blank" href="#">贴膜</a>
					</dd>
					<dd>
						<a target="_blank" href="#">耳机</a>
					</dd>
					<dd>
						<a target="_blank" href="#">数据线/充电器</a>
					</dd>
					<dd>
						<a target="_blank" href="#">周边产品</a>
					</dd>
				</dl>
				<dl class="cl">
					<dt>服务中心</dt>
					...
					<dd>
						<a target="_blank" href="#">软件下载</a>
					</dd>
				</dl>
				<dl class="cl">
					<dt>关注我们</dt>
					<dd>
						<a target="_blank" href="#">社区</a>
					</dd>
					<dd>
						<a target="_blank" href="#" target="_blank">新浪微博</a>
					</dd>
					<dd>
						<a target="_blank" href="#" target="_blank">QQ空间</a>
					</dd>
					<dd>
						<a href="javascript:;" id="wx">微信</a>
					</dd>
					<dd>
						<a target="_blank" href="#" target="_blank">百度贴吧</a>
					</dd>
				</dl>
...
#ft-wx:before {
	...
	background-repeat: no-repeat;
				...
				<div id="ft-wx">
					<img src="images/nb-weixin-code-figure.jpg" alt="" />
				</div>
			</div>
		</div>
	</div>
