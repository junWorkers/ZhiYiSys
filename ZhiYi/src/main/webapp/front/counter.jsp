...
<body>
	<div id="fa-moblie">
		...
		<div id="PageMain" class="main">
			<div id="pageImg">
				<img style="display:block" src="images/recommend_7.png" />
			</div>
			<div class="content">
					...
					<div class="container-app">
						...
						<div class="app-detail">
							<div class="app-content">
								<div class="left ">
									<img src="images/content_5.png" alt="" height="76" width="76">
									<a href="#">
										<h2>nubia计算器</h2> </a>
									<div class="star"></div>
								...
								<div class="right">
									<ul>
										<li><span>应用名称：</span>nubia计算器</li>
										<!-- 分类和价格先不实现。
									<li><span>分类：</span>1</li>
									<li><span>价格：</span> <b>免费</b> </li>
									-->
										<li><span>更新时间：</span>2015-09-02 17:14:37</li>
										<li><span>软件大小：</span>924.48KB</li>
										<li><span>开发商：</span>努比亚</li>
										<li><span>应用简介：</span>
											<p>nubia计算器V1.1</p>
											<p>横屏状态下自动切换为科学计算器哟！</p>
											<p>版本说明：</p>
											<p>
												1：最小可用的安卓版本调整到4.0<br> 2：竖屏下可以通过滑动打开科学计算器 <br>3：修正若干计算器BUG<br>4：优化apk大小
											</p></li>
									</ul>
								</div>
							</div>
