...
<body>
	...
	<div id="PageMain" class="main">
		<div id="pageImg">
			<img style="display: block" src="images/recommend_2.png" />
		</div>
		<div class="content">
				...
				<div class="container-app">
					...
					<div class="app-detail">
						<div class="app-content">
							...
							<div class="right">
								<ul>
									<li><span>应用名称：</span>nubia音乐</li>
									<!-- 分类和价格先不实现。
									<li><span>分类：</span>1</li>
									<li><span>价格：</span> <b>免费</b> </li>
									-->
									<li><span>更新时间：</span>2015-09-02 17:08:51</li>
									<li><span>软件大小：</span>8.27M</li>
									...
									<li><span>应用简介：</span>
										...
										<div>
											1、增加在线音乐搜索、榜单、歌单等功能<br> 2、优化电台模式<br> 3、增加网络歌曲下载功能<br>
											4、增加用户反馈功能<br> 5、增量在线升级功能<br>
											6. 音乐播放器歌词优化，增加歌词大小调节，歌词手动搜索<br>
											注：应用在部分非Nubia手机中会出现不兼容问题<br>
										</div>
										<p></p></li>
								</ul>
							</div>
