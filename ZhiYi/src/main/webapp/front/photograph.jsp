...
#photo05 .bx-prev {
	...
	z-index: 50;
	background:
		url(http://static.nubia.cn/product/max/images/photo_btns.png)
		no-repeat 0 -113px;
}
										...
										<div class="bx-wrapper" style="max-width: 100%;">
											<div class="bx-viewport"
												...
												<ul class="bxslider01"
													...
													<li
														style="float: none; list-style: none; position: absolute; width: 970px; z-index: 50; display: block;"><img
														src="${item.firstPath }"></li>
												</ul>
											</div>
