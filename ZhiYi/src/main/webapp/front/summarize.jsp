								...
								<div class="section summary03">
									<div class="w1170">
										...
										<div class="desc">
											<h1>${item.giname }
												<span
													style="color: red; font-size: 20px; vertical-align: text-top;">ⓟ</span><br>
											</h1>
...
#summary04 .bx-prev {
	...
	text-indent: -9999px;
	z-index: 9999;
	background: url(http://static.nubia.cn/product/z9/images/photo_btns.png)
		no-repeat 0 -113px;
}
...
#summary04 .bx-next {
	...
	z-index: 9999;
	background: url(http://static.nubia.cn/product/z9/images/photo_btns.png)
		no-repeat -86px -113px;
}

#summary04 a.disabled {
	display: none;
}
			...
			<c:forEach items="${goodsa}" var="item">
				<c:if test="${item.giattribute eq '概述'}">
					<c:if test="${item.giposition eq 3 }">
						<c:choose>
							<c:when test="${not empty item.firstPath }">
								<div class="section summary04" id="summary04"
									style="position: relative">
									<div class="bx-wrapper" style="max-width: 100%;">
										<div class="bx-viewport"
											style="width: 100%; overflow: hidden; position: relative; height: 798px;">
