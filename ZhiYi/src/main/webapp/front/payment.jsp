...
<body>
		...
		<div id="fa-header">
			<div id="fa-center">
				...
				<ul class="fa-centers">
					...
					<li><a href="front/index.jsp">服务</a>
					</li>
				...
				<ul class="fa-right">
					<c:if test="${not empty currentAdminInfo}">
						...
						<li style="display:none" id="usid">${currentUname.usid}</li>
		...
		<div class="bg-payorder">
			<div class="bg-nav" style="width: 250px;">
				<ul>
					...
					<li><a href="front/payment.jsp">填写购物车</a>
					</li>
				</ul>
			</div>
		</div>
							...
							<div class="con checkout">
								...
								<div class="address" id="shippingAddress">
									...
									<div class="subHd">
										<input
											...
											class="save" value="添加新地址" id="otherAddress" type="button" onClick="others()">
									</div>
								...
								<div id="cart" class="mod">
									...
									<div class="step2_Box" id="step2_Box">
										<table class="shoppingCart" border="0" height="50"
											width="100%">
											<thead>
												<tr>
													<th width="41%">商品名称</th>
	...
	<button style="float:right; margin-right:80px;background-color:red; color:white; width:100px; height:30px; font-weight:bold;" onClick="tijiao()">提交订单</button>
