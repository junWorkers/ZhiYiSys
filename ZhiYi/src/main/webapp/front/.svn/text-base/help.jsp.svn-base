...
<body>
	<div id="fa-moblie">
		...
		<div id="services">
			<ul>
				<li><a href="front/person.jsp" class="pic1"> <span class="pic"></span>
						<p>个人中心</p> </a>
				</li>

				<li><a href="front/shouhou.jsp" class="pic2"> <span class="pic"></span>
						<p>售后服务</p> </a>
				</li>

				<li><a href="front/wangdian.jsp" class="pic3"> <span class="pic"></span>
						<p>售后网点</p> </a>
				</li>

				<li><a data-toggle="tab" class="pic4"> <span class="pic"></span>
						<p class="pp3">帮助中心</p> </a>
				</li>
		...
		<div id="services-con">
			<ul>
				<li class="m"><a data-toggle="tab" href="front/help.jsp#policy0001"
					class="img" onClick="change3('1')"> <span class="img1"></span><span
						class="content">产品咨询</span> </a>
				</li>

				<li class="m"><a data-toggle="tab" href="front/help.jsp#policy0002"
					class="img" onClick="change3('2')"> <span class="img1"></span><span
						class="content">产品订购</span> </a>
				</li>


				<li class="m"><a data-toggle="tab" href="front/help.jsp#policy0003"
					class="img" onClick="change3('3')"> <span class="img1"></span><span
						class="content">支付及配送</span> </a>
				</li>


				<li class="m"><a data-toggle="tab" href="front/help.jsp#policy0004"
					class="img" onClick="change3('4')"> <span class="img1"></span><span
						class="content">服务问题</span> </a>
				</li>


				<li class="m"><a data-toggle="tab" href="front/help.jsp#policy0005"
					class="img" onClick="change3('5')"> <span class="img1"></span><span
						class="content">特色服务</span> </a>
				</li>


				<li class="m"><a data-toggle="tab" href="front/help.jsp#policy0006"
					class="img" onClick="change3('6')"> <span class="img1"></span><span
						class="content">技术问题</span> </a>
				</li>

				<li class="m"><a data-toggle="tab" href="front/help.jsp#policy0007"
					class="img" onClick="change3('7')"> <span class="img1"></span><span
						class="content">会员介绍</span> </a>
				</li>


				<li class="m"><a data-toggle="tab" href="front/help.jsp#policy0008"
					class="img" onClick="change3('8')"> <span class="img1"></span><span
						class="content">牛豆说明</span> </a>
				</li>
				...
				<div class="tab-content">
					...
					<div id="faq004" class="s-con-nest tab-pane">
						<div class="question-container services-p">
							...
							<p class="answer">A1:
								包含主机、充电器、数据线、取卡器、保修卡、售后电话清单、快速指引（彩盒内托上）。</p>
					...
					<div id="faq0604" class="s-con-nest tab-pane">
						<div class="services-p">
							<div class="question-container">
								...
								<p class="answer">A2:
									只有在nubia官网或官方线下专卖店购买的努比亚手机，才支持线上线下跨店退货。</p>
					...
					<div id="faq0606" class="s-con-nest tab-pane">
						<div class="services-p">
							<div class="question-container">
								...
								<p class="answer">A1:
									意外宝服务必须与手机同时购买，不能单独办理。建议您在购买手机时与手机同时购买。</p>
								<p class="ask">Q2:
									“意外宝”服务可以办理延期吗（延期指“意外宝”结束后就同一手机再次购买“意外宝”）？</p>
			...
			<div id="policy0006" class="s-pay-con-tab-pane">
				...
				<div class="Zfaq11" style="" id="Zfaq1">
					<ul class="s-list-nest nav nav-tabs" id="s-list-nest1">
						<li><a data-toggle="tab" href="#z9faq051"
							onClick="change9(1)">>联系人</a></li>
						<li><a data-toggle="tab" href="#z9faq052"
							onClick="change9(2)">>软件与应用程序</a></li>
						<li><a data-toggle="tab" href="#z9faq053"
							onClick="change9(3)">>通话</a></li>
						<li><a data-toggle="tab" href="#z9faq054"
							onClick="change9(4)">>信息</a></li>
						<li><a data-toggle="tab" href="#z9faq055"
							onClick="change9(5)">>上网</a></li>
					</ul>
					<div class="tab-content">
						...
						<div id="z9faq055" class="s-con-nest tab-pane">
							<div class="services-p">
								<div class="question-container">
									...
									<p></p>
									<p class="answer">
										如果确认以上情况正常，参照其他的机器设置对应的APN，保存并勾选数据漫游选项即可。</p>
						...
						<div id="faq051" class="s-con-nest tab-pane1">
							<div class="services-p">
								<div class="question-container">
									...
									<div style="text-align: center;">
										<img data-pinit="registered" src="images/0.jpg"
											alt="nubia FAQ">
									</div>
						...
						<div id="faq052" class="s-con-nest tab-pane">
							<div class="services-p">
								<div class="question-container">
									...
									<p class="ask">Q4: 如何查看手机的版本信息？</p>
									<p class="answer">A：请按如下操作查看手机相关信息：在待机屏幕选择“设置→关于手机”查看有关信息。
									</p>
									<p class="ask">Q5: 如何将手机恢复出厂设置？</p>
									...
									<div class="question-container">
										...
										<p class="answer">（2）恢复出厂设置后会清除手机设置及保存在手机里的信息,请您提前备份用户数据。
										</p>
										<p class="ask">Q6:如何卸载手机上的应用程序？</p>
										<p class="answer">A:卸载手机上的应用程序有两种方法：</p>
