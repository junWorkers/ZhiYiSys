	...
	<div id="banner_tabs" class="ui-content-1 ui-carousel flexslider">
		<ul id="slides">
			<li id="b1" style="display: block"><a href="front/camera.jsp"><img
					src="images/recommend_1.png" /> </a></li>
			<li style="display: none" id="b2"><a href="front/music.jsp"><img
					src="images/recommend_2.png" /> </a></li>
			<li style="display: none" id="b3"><a href="front/shijie.jsp"><img
					src="images/recommend_3.png" /> </a></li>
			<li style="display: none" id="b4"><a href="front/mall.jsp"><img
					src="images/recommend_4.png" /> </a></li>
		</ul>

		<ol id="bannerCtrl" class="flex-control-nav flex-control-paging">
			<li id="a1" class="current"><a>1</a></li>
			<li id="a2" class="current"><a>2</a></li>
			<li id="a3" class="active current"><a>3</a></li>
			<li id="a4" class="current"><a>4</a></li>
		</ol>
	</div>
		...
		<div class="container-theme-app">
			<div class="container-app">
				...
				<ul class="app-list">
					...
					<li><a href="front/share.jsp"> <img
							src="images/content_4.png" alt="" height="76" width="76">
					</a> <a href="front/share.jsp">
							<h2>互动分享</h2>
					</a>
						<div class="star"></div>
						<div class="btn">
					...
					<li><a href="front/music.jsp"> <img
							src="images/content_7.png" alt="" height="76" width="76">
					</a> <a href="front/music.jsp">
							<h2>nubia音乐</h2>
					</a>
						<div class="star"></div>
						<div class="btn">
					...
					<li><a href="front/mall.jsp"> <img
							src="images/content_11.png" alt="" height="76" width="76">
					</a> <a href="front/mall.jsp">
							<h2>努比亚商城</h2>
					</a>
						<div class="star"></div>
						<div class="btn">
