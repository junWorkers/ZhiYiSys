...
<body>
		...
		<div class="pdtby-inner">
			<div class="pdtby-details">
				...
				<div id="siber" class="pdtby-img">
					<a class="current" onClick="blocks(this,1)"> <img
						src="images/pizhi-1.png">
					</a> <a class="" onClick="blocks(this,2)"> <img
						src="images/pizhi-5.png">
					</a>
				</div>
				...
				<div class="pdtby-btn-groups" style="margin-top: 30px;">
					...
					<div style="display: none;" class="btn-gobuy-qhdj"
						id="arrivalnotice">缺货登记</div>
				</div>
			</div>
				...
				<div id="1" class="lunbo" style="display: block">
					<div class="tabs">
						<ul id="show_img1" class="thuma">
							<li style="display: block"><img src="images/pizhi-1.png"
								alt="Z9 Max皮质保护套"></li>
							<li style="display: none"><img src="images/pizhi-2.png"
								alt="Z9 Max皮质保护套"></li>
							<li style="display: none"><img src="images/pizhi-3.png"
								alt="Z9 Max皮质保护套"></li>
							<li style="display: none"><img src="images/pizhi-4.png"
								alt="Z9 Max皮质保护套"></li>
						</ul>
					</div>
					<div>
				...
				<div id="2" class="lunbo" style="display: none">
					<div class="tabs">
						<ul id="show_img" class="thuma">
							<li style="display: block"><img src="images/pizhi-5.png"
								alt="Z9 Max皮质保护套"></li>
							<li style="display: none"><img src="images/pizhi-6.png"
								alt="Z9 Max皮质保护套"></li>
							<li style="display: none"><img src="images/pizhi-7.png"
								alt="Z9 Max皮质保护套"></li>
							<li style="display: none"><img src="images/pizhi-8.png"
								alt="Z9 Max皮质保护套"></li>
						</ul>
					</div>
					<div>
	...
	<div class="pdt-content">
		<div class="tab-content">
			<div class="tab-pane active" id="myTab01"
				style="width: 1170px; margin: 0 auto;">
				<div>
					<img alt="Z9 Max皮质保护套" src="images/pizhi-d1.jpg">
				</div>
				<div>
					<img alt="Z9 Max皮质保护套" src="images/pizhi-d2.jpg">
				</div>
				<div>
					<img alt="Z9 Max皮质保护套" src="images/pizhi-d3.jpg">
				</div>
				<div>
					<img alt="Z9 Max皮质保护套" src="images/pizhi-d4.jpg">
				</div>
				<div>
					<img alt="Z9 Max皮质保护套" src="images/pizhi-d5.jpg">
				</div>
				<div>
					<img alt="Z9 Max皮质保护套" src="images/pizhi-d6.jpg">
				</div>
				<div>
					<img alt="Z9 Max皮质保护套" src="images/pizhi-d7.jpg">
				</div>
			</div>
		</div>
	</div>
